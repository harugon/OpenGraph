...
## 依存する拡張
* [Extension:TextExtracts](https://www.mediawiki.org/wiki/Extension:TextExtracts/ja) TextExtractsを使用しmeta descriptionを追加します。
* [Extension:PageImages](https://www.mediawiki.org/wiki/Extension:PageImages) 直接依存していませんが PageImagesが``og:image``,``twitter:image``を追加しています
